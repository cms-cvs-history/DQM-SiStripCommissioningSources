#ifndef DQM_SiStripCommon_SiStripHistoNamingSchemeMtcc_H
#define DQM_SiStripCommon_SiStripHistoNamingSchemeMtcc_H
...
class SiStripHistoNamingSchemeMtcc {
  
 public:

  // ----- STRUCTS AND ENUMS -----

  enum Task        { UNKNOWN_TASK,     NO_TASK,  PEDESTALS };
  enum Contents    { UNKNOWN_CONTENTS, COMBINED, SUM2, SUM, NUM, RAWNOISE, CMNOISE, PEDS };
  ...
  static string histoTitle( Task        task,
			    Contents    contents   = SiStripHistoNamingSchemeMtcc::COMBINED, 
			    KeyType     key_type   = SiStripHistoNamingSchemeMtcc::NO_KEY, 
			    uint32_t    key_value  = 0, 
			    Granularity granarity  = SiStripHistoNamingSchemeMtcc::MODULE,
			    uint16_t    channel    = 0,
			    string      extra_info = "" );
 ...
 private: // ----- private data members -----
  ...
  static const string rawnoise_;
  static const string cmnoise_;
  static const string peds_;
...
#endif // DQM_SiStripCommon_SiStripHistoNamingSchemeMtcc_H
