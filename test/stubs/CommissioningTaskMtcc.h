...
//#include "DQM/SiStripCommissioningSourcesMtcc/interface/CommissioningSourceMtcc.h"
...
void CommissioningTaskMtcc::fedChannel( const uint32_t& fed_key ) { fedChannel_ = SiStripGenerateKey::fedChannel( fed_key ); }
